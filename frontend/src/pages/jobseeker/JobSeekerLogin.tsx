...
//           <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-2 sm:mb-3 lg:mb-4">Your Next Opportunity Awaits</h2>
...
import { Label } from "@/components/ui/label";
import { toast } from "@/hooks/use-toast";
import { API_BASE_URL } from "../../config.js"; // e.g., "http://localhost:5000/api"
